        ...
        <div className="auth-branding">
          ...
          <div className="auth-branding-content">
            <h2 className="auth-branding-title">
              Start Creating <span className="text-gradient">Amazing</span> Documentation
            </h2>
            <p className="auth-branding-desc">
              Join thousands of developers using VibeDocs to create stunning README files in seconds.
            </p>
        ...
        <div className="auth-form-section">
          <div className="auth-card">
            <div className="auth-card-header">
              ...
              <p className="auth-subtitle">Get started with VibeDocs for free</p>
            </div>
